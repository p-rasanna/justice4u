...
<nav class="app-header navbar navbar-expand bg-white border-bottom shadow-none">
  ...
  <ul class="navbar-nav align-items-center">
    ...
    <span class="text-serif fw-bold text-dark fs-5"><%= request.getParameter("title") != null ? request.getParameter("title") : "Workspace" %></span>
    </li>
  </ul>
  <ul class="navbar-nav ms-auto align-items-center">
    ...
    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-3 p-2" style="min-width: 200px; border-radius: 12px;">
      ...
      <li><hr class="dropdown-divider opacity-50"></li>
      <li>
      <a href="<%= cp %>/shared/signout.jsp?role=<%= currentRole %>" class="dropdown-item rounded-3 py-2 small text-danger">
