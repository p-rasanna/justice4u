                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        try(Connection con=DatabaseConfig.getConnection()){
                                            PreparedStatement ps=con.prepareStatement("SELECT lid, lname, email, specialization, amount, document_verification_status FROM lawyer_reg WHERE status='PENDING' OR flag=0 ORDER BY lid DESC");
