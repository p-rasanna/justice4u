...
<head>
    ...
    <title>Page Not Found - Justice4U</title>
...
<body>
    <div class="error-card">
        <i class="ph-duotone ph-map-pin-line error-icon"></i>
        <h1>404 Not Found</h1>
        <p>The page you are looking for has been moved, deleted, or does not exist on our servers.</p>
        <a href="Home.html" class="btn-home">Return to Homepage</a>
    </div>
</body>
</html>
