...
public class ClientDashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Fallback for legacy sessions or inconsistent attributes
        ...
        try {
            // Retrieve cases entirely from DAO
            List<Map<String, Object>> caseList = caseDAO.getCasesByClientEmail(email);

            // Push data purely as request attributes to keep JSP clean
            ...
            // Rather than swallow error, escalate it to be cleanly caught by global error
            // page
