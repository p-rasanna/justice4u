...
public class CaseDAO {
    ...
    /**
     * Retrieves all cases for a specific client based on their email.
     * Uses PreparedStatement and try-with-resources.
     * 
     * @param email The client's registered email
     * @return List of case maps containing column data
     * @throws SQLException If database access fails
     */
    public List<Map<String, Object>> getCasesByClientEmail(String email) throws SQLException {
        List<Map<String, Object>> cases = new ArrayList<>();

        // Use PreparedStatement logic exclusively
