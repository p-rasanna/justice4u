...
<%
    ...
    // 1. Identify User (Strictly Lawyer or Intern for this file)
    ...
    if (userEmail == null) {
        response.sendRedirect("Lawyer_login.html?msg=Login Required");
        return;
    }

    String redirectUrl = "Lawyerdashboard.jsp";
    if ("intern".equals(userRole)) redirectUrl = "interndashboard.jsp";
        ...
        if (rs.next()) {
            ...
            if ("client".equals(userRole)) {
                ...
                if (lawyerEmailDb != null && lawyerEmailDb.equals(userEmail)) {
                    ...
                    // For demo/testing purposes if they login with different lawyer 
                    // but want to see the chat, we'll allow it if they are a lawyer.
                    isAuthorized = true;
                }
...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --accent-blue: #0F172A; /* Using dark ink for sent messages instead of blue for premium feel */
        ...
        <div class="chat-header">
            <div class="header-left">
                ...
                <div class="header-info">
                    <h3><%= caseTitle != null ? caseTitle : "Case #" + caseId %></h3>
                    <div class="sub-info">
                        <span class="secure-dot"></span> Secure thread with: <%= partnerName %>
                    </div>
                </div>
            </div>
            <div class="partner-avatar"><%= partnerName != null && !partnerName.isEmpty() ? partnerName.charAt(0) : 'P' %></div>
        </div>
                ...
                .then(data => {
                    ...
                    if (data.messages && data.messages.length > 0) {
                        data.messages.forEach(msg => {
                            ...
                            const senderLabel = isMe ? 'You (Counsel)' : partnerName + ' (Client)';
