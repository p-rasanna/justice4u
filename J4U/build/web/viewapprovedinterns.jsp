...
<head>
    <meta charset="UTF-8">
    <title>Justice4U | Approved Interns</title>
...
<div class="app">
    ...
    <aside class="sidebar" role="navigation">
        ...
        <div class="nav-section">
            ...
            <a href="viewapprovedinterns.jsp" class="nav-item active"><i class="ph-light ph-graduation-cap"></i> Active Interns</a>
        </div>
    ...
    <main class="main" role="main">
        ...
        <div class="topbar reveal r1">
            <div class="topbar-left">
                <h1>Active <em>Interns</em></h1>
                <p><i class="ph-light ph-graduation-cap"></i> System Verified Student Directory</p>
            </div>
        </div>
        ...
        <div class="panel reveal r2">
            <div class="panel-head">
                <h3><i class="ph-light ph-users panel-icon"></i> Verified Intern Roster</h3>
...
<%@include file="db_connection.jsp" %>
              <%
                ...
                try {
                  ...
                  String query = "SELECT * FROM intern WHERE flag = 1";
