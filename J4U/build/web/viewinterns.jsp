...
<head>
    <meta charset="UTF-8">
    <title>Justice4U | Intern Approvals</title>
    ...
    <style>
        /* =====================================================================
           JUSTICE4U — ADMIN COMMAND CENTER (INTERN APPROVALS)
...
<div class="app">
    ...
    <aside class="sidebar" role="navigation">
        ...
        <div class="nav-section">
            ...
            <a href="ViewInterns" class="nav-item active"><i class="ph-light ph-user-plus"></i> Intern Applications</a>
        </div>
    ...
    <main class="main" role="main">
        ...
        <div class="topbar reveal r1">
            <div class="topbar-left">
                <h1>Intern <em>Applications</em></h1>
                <p><i class="ph-light ph-graduation-cap"></i> Legal Scholar Program Verification</p>
            </div>
        </div>
        ...
        <div class="panel reveal r2">
            <div class="panel-head">
                <h3><i class="ph-light ph-users panel-icon"></i> Incoming Students</h3>
            ...
            <div class="table-responsive">
              ...
              <c:choose>
                <c:when test="${not empty pendingInterns}">
                  <c:forEach var="intern" items="${pendingInterns}">
                    <tr>
                      ...
                      <td style="font-weight:500;"><c:out value="${intern.name}" /></td>
                      ...
                      <td style="font-weight:500;"><c:out value="${intern.amount}" /></td>
                      <td>
                        <span class="status-pill status-pending">
                          <i class='ph-light ph-clock'></i> Pending
                        </span>
                      </td>
                      <td>
                        <div class="action-flex">
                          <a href="approvei.jsp?id=${intern.id}" class="btn-action btn-approve" onclick="return confirm('Officially approve this intern?')">
                ...
                <c:otherwise>
                  <tr>
                    <td colspan="14" style="text-align: center; padding: 40px; color: var(--text-faint);">No pending intern applications right now.</td>
                  </tr>
                </c:otherwise>
              </c:choose>
              </tbody>
